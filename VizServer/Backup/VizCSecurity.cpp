...
Protection(protection), Negotiable(negotiable), SecurityPeriods(securityPeriods), NegotiableStart(negotiableStart), NegotiableEnd(negotiableEnd), InfoUpdated(infoUpdated)
{
}
//-----------------------------------------------------------------------------
...
void VizCSecurity::mergeAttributes(const VizCSecurity& other)
{
	...
	Negotiable = (other.Negotiable) ? other.Negotiable : Negotiable;

	// Casos que exigem cuidado para sincronização no Server apenas!
	// Esses atributos não podem ser invertidos, isto é, o atributo do banco
	// sempre tem q ser o other
...
// 	NegotiableEnd = other.NegotiableEnd > NegotiableEnd ? other.NegotiableEnd : NegotiableEnd;
	...
	NegotiableStart = (other.NegotiableStart > NegotiableStart) ? other.NegotiableStart : NegotiableStart;
	NegotiableEnd = (other.NegotiableEnd > NegotiableEnd) ? other.NegotiableEnd : NegotiableEnd;
...
//-----------------------------------------------------------------------------
quint16 VizCSecurity::crc() const
{
