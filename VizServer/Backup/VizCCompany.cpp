...
{
//-----------------------------------------------------------------------------
VizCCompany::VizCCompany() : CompanyId(-1), Name(""), WholeName(""), PartialSecuritySymbol(""), CNPJ(""), IssuerCreation(QDate()), CurrentStatus(""), InfoUpdated(QDate())
{
}
//-----------------------------------------------------------------------------
VizCCompany::VizCCompany(const QString& name, const QString& wholeName, const QString& partialSecuritySymbol, const QString& cnpj, const QDate& issuerCreation, const QString& currentStatus, const QDate& infoUpdated, const u32& ccvm, const QVector<VizCSecurity>& securities) : CompanyId(-1), Name(name), WholeName(wholeName), PartialSecuritySymbol(partialSecuritySymbol), CNPJ(cnpj), IssuerCreation(issuerCreation), CurrentStatus(currentStatus), Securities(securities), InfoUpdated(infoUpdated), CCVM(ccvm)
{
}
//-----------------------------------------------------------------------------
...
//-----------------------------------------------------------------------------
void VizCCompany::set(s32 companyId, const QString& name, const QString& wholeName, const QString& partialSecuritySymbol, const QString& cnpj, const QDate& issuerCreation, const QString& currentStatus, const QDate& infoUpdated, const u32& ccvm, const QVector<VizCSecurity>& securities)
{
	CompanyId = companyId;
	Name = name;
	WholeName = wholeName;
...
//-----------------------------------------------------------------------------
void VizCCompany::get(s32 companyId, QString& name, QString& wholeName, QString& partialSecuritySymbol, QString& cnpj, QDate& issuerCreation, QString& currentStatus, QDate& infoUpdated, u32& ccvm, QVector<VizCSecurity>& securities) const
{
	companyId = CompanyId;
	name = Name;
	wholeName = WholeName;
...
{
	set(other.CompanyId, other.Name, other.WholeName, other.PartialSecuritySymbol, other.CNPJ, other.IssuerCreation, other.CurrentStatus, other.InfoUpdated, other.CCVM, other.Securities);
}
//-----------------------------------------------------------------------------
void VizCCompany::get(VizCCompany& other) const
{
	get(other.CompanyId, other.Name, other.WholeName, other.PartialSecuritySymbol, other.CNPJ, other.IssuerCreation, other.CurrentStatus, other.InfoUpdated, other.CCVM, other.Securities);
}
//-----------------------------------------------------------------------------
